...
// ENGELSK
  ...
  export const enCards = [
    {
      title: "Rule",
      desc: "The person who drew this card can now make a rule that applies to the rest of the game. Anyone who breaks the rule must take a sip.",
      src: "ace_of_clubs.png"
    },
    {
      title: "Rule",
    ...
    },
    {
      ...
      desc: "Choose one of the other players who must drink every time you drink. This rule lasts until someone else becomes drinking partners.",
      src: "ace_of_hearts.png"
    },
    {
      title: "Drinking partner",
    ...
    {
      title: "Hand out",
      desc: "The player who drew this card can now hand out four sips to the other players. You can give all the sips to the same person, or you can split them up.",
      src: "4_of_hearts.png"
    },
    {
      title: "Hand out",
      ...
      title: "Hand out",
      desc: "The player who drew this card can now hand out five sips to the other players. You can give all the sips to the same person, or you can split them up.",
      src: "5_of_clubs.png"
    },
    {
      title: "Hand out",
    ...
    },
    {
      ...
      desc: "Everyone around the table joins a game of black and white. The minority is knocked out each round. Everyone who is knocked out before, or at the same time as the person who drew this card must take a sip. For every round the player who drew the card survives, all the players who is already knocked out must take another sip.",
      src: "6_of_clubs.png"
    },
    {
      title: "Black and white",
    ...
    },
    {
      ...
      desc: "From now on it is not allowed to see the player who drew this card in the eyes. If you make eye contact with this player, you must take a sip. This lasts until someone else gets poisonous eyes.",
      src: "8_of_clubs.png"
    },
    {
      title: "Poisonous eyes",
